 ...
 * @author khalid
 */
public class CarritoInterfaz extends javax.swing.JDialog {

    /**
     * Creates new form CarritoInterfaz
     */
//    public CarritoInterfaz(java.awt.Frame parent, boolean modal) {
//        super(parent, modal);
//        initComponents();
//    }
    private ComprarMenu padre;
     
    public CarritoInterfaz(ComprarMenu ventana, boolean modal) {
        super(ventana, modal);
        padre = ventana;
        initComponents();
...
//            java.util.logging.Logger.getLogger(CarritoInterfaz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                CarritoInterfaz dialog = new CarritoInterfaz(new javax.swing.JFrame(), true);
